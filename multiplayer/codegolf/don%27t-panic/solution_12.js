...
function seekTarget(TargetPos, ClonePos, dir){
    if((TargetPos < ClonePos && dir === "RIGHT") ||
        TargetPos > ClonePos && dir === "LEFT" ){
        print("BLOCK");
    } else {
        print("WAIT");
    }
...
while (true) {
    ...
    if(cloneFloor < exitFloor)
        seekTarget(LiftPos[cloneFloor], clonePos, direction);
    else
        seekTarget(exitPos, clonePos, direction);
}